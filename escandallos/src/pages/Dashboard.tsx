...
import { ChefHat, Users, ShoppingCart, AlertTriangle, TrendingDown, TrendingUp, Package } from "lucide-react";
...
export default function Dashboard() {
  ...
  if (!data) {
    return <div className="p-6 text-center text-gray-500">Error al cargar datos</div>;
  }
    ...
    <div className="p-6">
        ...
        <div className="bg-white rounded-lg shadow p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-2xl font-bold text-gray-800">{data.total_recetas}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-2xl font-bold text-gray-800">{data.total_ingredientes}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-2xl font-bold text-gray-800">{data.total_proveedores}</p>
            </div>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between p-3 bg-green-50 rounded-lg">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-medium">Receta más rentable</span>
              </div>
        ...
        <div className="bg-white rounded-lg shadow p-6 lg:col-span-2">
          ...
          {data.ultimos_albaranes.length === 0 ? (
